...
# ===========================================
# PART 2: Parallel Processing for Higher Dimensions
# ===========================================
...
# ===========================================
# PART 3: Running the Analysis for Dimensions Up to 25
# ===========================================

if __name__ == '__main__':
    radius = 1.0
    num_points = 200  # Increase the number of points to enhance sphere approximation accuracy
    ...
    all_spheres_analysis_df.to_csv("spheres_analysis_up_to_dim_25.csv", index=False)
