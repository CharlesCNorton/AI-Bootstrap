...
def L_n(a0, epsilon, n):
    ...
    if base > 0:
        ...
        term1 = np.nan  # Invalid operation
...
def P_n(a0_1, a0_2, epsilon, n):
    ...
    if base2 > 0:
        ...
        term2 = np.nan  # Invalid operation
...
def F_n(a0_base, a0_fiber1, a0_fiber2, epsilon, n):
    ...
    if base > 0:
        ...
        base_term = np.nan  # Invalid operation
    ...
    if fiber1_base > 0:
        ...
        fiber1_term = np.nan  # Invalid operation
    fiber1_term /= 2
    ...
    if fiber2_base > 0:
        ...
        fiber2_term = np.nan  # Invalid operation
    fiber2_term /= 2
