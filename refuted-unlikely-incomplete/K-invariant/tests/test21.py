...
def run_specific_tests(test_cases, constant_factor, interaction_strength):
    """
...
def expand_test_suite():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "Known_Homotopy_Groups": {3: 2}    # pi_3(Suspension(T^2)) = pi_3(T^2) + pi_2(T^2) = 2
        },
        {
...
def parameter_optimization_optuna(specific_results, edge_case_results):
    """
    Optimizes CONSTANT_FACTOR and INTERACTION_STRENGTH using Bayesian Optimization (Optuna).
    """
    def objective(trial):
        ...
        for result in combined_results:
            ...
            # Compute K_M with current trial parameters
            K_M = compute_K_M(
                betti_sum=betti_sum,
                num_vertices=num_vertices,
                dimension=dimension,
...
def parameter_optimization_genetic(specific_results, edge_case_results):
    """
    Optimizes CONSTANT_FACTOR and INTERACTION_STRENGTH using Genetic Algorithms (DEAP).
    """
    ...
    def evaluate(individual):
        ...
        for result in combined_results:
            ...
            # Compute K_M with current individual parameters
            K_M = compute_K_M(
                betti_sum=betti_sum,
                num_vertices=num_vertices,
                dimension=dimension,
    ...
    creator.create("FitnessMax", base.Fitness, weights=(1.0,))  # Maximizing score
...
def parameter_optimization(specific_results, edge_case_results):
    """
    Optimizes parameters using both Optuna (Bayesian) and Genetic Algorithms, then selects the best.
    """
...
def main():
    ...
    specific_results_initial = run_specific_tests(
    ...
    # Additional Specific Test Cases
    additional_specific_results_initial = run_specific_tests(
    ...
    edge_case_results_initial = run_specific_tests(
    ...
    specific_results_optimized = run_specific_tests(
    ...
    # Additional Specific Test Cases
    additional_specific_results_optimized = run_specific_tests(
        test_cases=test_cases[5:],  # Remaining are additional specific tests
        constant_factor=optimized_params['CONSTANT_FACTOR'],
        interaction_strength=optimized_params['INTERACTION_STRENGTH']
    )
    ...
    edge_case_results_optimized = run_specific_tests(
        test_cases=edge_case_tests,
        constant_factor=optimized_params['CONSTANT_FACTOR'],
        interaction_strength=optimized_params['INTERACTION_STRENGTH']
    )
...
def parameter_optimization_genetic(specific_results, edge_case_results):
    ...
    # Setup DEAP framework
    creator.create("FitnessMax_GA", base.Fitness, weights=(1.0,))  # Maximizing score
...
def parameter_optimization(specific_results, edge_case_results):
    """
    Optimizes CONSTANT_FACTOR and INTERACTION_STRENGTH using both Optuna (Bayesian) and Genetic Algorithms.
