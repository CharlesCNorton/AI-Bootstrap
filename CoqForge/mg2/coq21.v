...
Record ChernClass := {
  ...
  multiplicative : forall (v1 v2 : VectorBundle),
    value {|
      ...
      chern_nontrivial := mult_nonzero_helper _ _ (chern_nontrivial v1) (chern_nontrivial v2)
    |} = value v1 * value v2;
...
Record GeometricFiltration := {
  ...
  polynomial_bound : forall (M : MotivicSpace) (n : nat),
    ...
    Rabs (geometric_piece M - P M) <= INR (1/n);
  ...
  chern_polynomial_bound : forall (v : VectorBundle) (c : ChernClass),
    ...
    (forall M : MotivicSpace,
      ...
      INR (rank v) * chern_class v * (1/INR (degree c)));
