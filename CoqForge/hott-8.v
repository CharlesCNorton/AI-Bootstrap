...
Axiom nat_ge_trans : forall n m p : nat,
  n >= m -> m >= p -> n >= p.

Axiom Rlt_trans : forall x y z : R,
  Rlt x y -> Rlt y z -> Rlt x z.

Axiom nat_le_refl : forall n : nat, n <= n.
Axiom nat_le_succ : forall n : nat, n <= S n.
...
Axiom nat_le_lt_trans : forall n m p : nat,
  n <= m -> m < p -> n < p.

Axiom nat_lt_le_trans : forall n m p : nat,
  n < m -> m <= p -> n < p.
