...
# Step 1: Construct Cartan Matrices for Exceptional Lie Groups

def construct_cartan_matrix(group_name):
    if group_name == 'E8':
        # E8 Cartan matrix (8 x 8)
...
# Step 2: Generate Full Root System using Weyl Reflections
...
def generate_full_root_system(cartan_matrix):
    ...
    # Construct all possible roots using Weyl reflections
    root_system = set()
...
# Step 3: Define Full Chevalley Basis for Lie Algebra -- Root and Cartan Elements
...
# Step 5: Generate Conjugacy Classes by Conjugation
...
def main():
    ...
    for group_name in groups:
        logging.info(f"Calculating SOE for {group_name}...")
        ...
        logging.info(f"Symmetry Orbit Entropy for {group_name}: {entropy}")
